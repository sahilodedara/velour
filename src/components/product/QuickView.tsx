      ...
      <div className="grid gap-6 md:grid-cols-2">
        ...
        <div className="flex flex-col">
          ...
          {product.colors.length > 1 && (
            <div className="mt-5">
              <p className="mb-2 text-[0.7rem] uppercase tracking-[0.18em] text-ink-soft">Color: {color}</p>
          ...
          {product.sizes && (
            <div className="mt-5">
              <p className="mb-2 text-[0.7rem] uppercase tracking-[0.18em] text-ink-soft">Size</p>
          ...
          <div className="mt-auto pt-6">
            ...
            <p className="mt-3 flex items-center justify-center gap-1.5 text-xs text-ink-muted">
              <Check size={13} className="text-success" /> In stock — {product.stock} available
            </p>
          </div>
        </div>
      </div>
